...
// cosCumparaturi::cosCumparaturi(const listaCumparaturi &lista_, const std::vector<Item> &items_, double totalPlata_): list(lista_),items(items_), totalPlata(totalPlata_) {}

// cosCumparaturi::cosCumparaturi(const cosCumparaturi &other): list(other.list),items(other.items), totalPlata(other.totalPlata) {}
//
...
//
// const listaCumparaturi & cosCumparaturi::getLista() const {return list;}
//
